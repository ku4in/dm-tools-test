...
MAX_CLIENTS=65534
DOWNLOAD_PERIOD=10    # Period in days the download link will be valid
...
download_config () {
	...
	echo "Links will be valid for $DOWNLOAD_PERIOD days!"
	client_name=$1
	if [ -z "$client_name" ]; then
		...
		expires=`date +%s --date="today + $DOWNLOAD_PERIOD days"`
